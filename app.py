...
class HelpCenterRAG:
    ...
    def find_relevant_sections(
        self, query: str, top_k: int = 15, min_score: float = 0.4
    ) -> List[dict]:
        """
    ...
    messages = [
        {
            "role": "system",
            "content": (
                "**你是一个专门为 FastBull 提供帮助的客户服务助理，FastBull 是一家全球知名的金融服务提供商。** 你的主要任务是**根据提供的FastBull帮助中心文档摘录**来回答用户的问题。\n\n"
                "**你必须严格遵守以下准则：**\n"
                "1. **回答格式：** 以自然、专业的语气提供简洁明了的答案。**时刻牢记你代表FastBull，需将用户满意度放在首位，回答问题时无需说明参考了其他来源的信息。**\n"
                "2. **信息来源说明：** 如果可能，请注明信息来源的网址。\n"
